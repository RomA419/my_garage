...
class UserModel {
  ...
  factory UserModel.fromMap(Map<String, dynamic> m) => UserModel(
    ...
    settings: m['settings_json'] != null
        ? (jsonDecode(m['settings_json'] as String) as Map<String, dynamic>?) ??
              {}
        : {},
  );
...
class CarModel {
  ...
  String get localizedType {
    final localeKey = typeIndex >= 0 && typeIndex < _carTypeLocaleKeys.length
        ? _carTypeLocaleKeys[typeIndex]
        : _carTypeKeyByName[type] ?? type;
    return _carTypeLocaleKeys.contains(localeKey)
        ? LocaleService.tr(localeKey)
        : localeKey;
  }

  String get title =>
      brand.isNotEmpty ? '$brand $localizedType' : localizedType;
...
class FuelRecordModel {
  ...
  @override
  String toString() => 'FuelRecordModel(id: $id, $station, $subType, $total ₸)';

  @override
  bool operator ==(Object other) =>
      identical(this, other) || (other is FuelRecordModel && other.id == id);
...
class MaintenanceRecord {
  ...
  factory MaintenanceRecord.fromMap(Map<String, dynamic> m) =>
      MaintenanceRecord(
        id: m['id'] as int?,
        userId: m['user_id'] as int? ?? 0,
        carId: m['car_id'] as int?,
