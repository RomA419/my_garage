...
class _MaintenancePageState extends State<MaintenancePage> {
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  _field(theme, costCtrl, LocaleService.tr('maintenanceCost'),
                      Icons.payments_outlined,
                      isNumber: true),
                  const SizedBox(height: 14),

                  _field(theme, odometerCtrl,
                      LocaleService.tr('odometerKm'), Icons.speed,
                      isNumber: true),
                  const SizedBox(height: 14),

                  _field(theme, notesCtrl,
                      LocaleService.tr('maintenanceNotes'), Icons.notes),
  ...
  Widget _field(ThemeData theme, TextEditingController ctrl, String label,
      IconData icon,
      {bool isNumber = false}) {
    final isDark = theme.brightness == Brightness.dark;
    return TextField(
  ...
  Widget build(BuildContext context) {
    ...
    final totalCost = records.fold<double>(
        0, (s, r) => s + (double.tryParse(r.cost) ?? 0));
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: Text(tr('addMaintenanceRecord')),
      ),
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          CurrencyService.format(double.tryParse(item.cost) ?? 0, currency),
